<div id="drug_charges" data-clear="neighborhoods,blockgroups" data-section="drug_charges" data-quantifier="incidents" data-quantifier_args='{literal}{"desc": "DRUG CHARGES", "ncode": ["IVDRUG", "IVPREM", "INVEST"]}{/literal}' data-quantify="blockgroups">
	...
	<p>
	This map shows the level of inequality (defined as: "how many standard deviations higher the number of incidents present in a 'blockgroup' is compared to the mean amount of incidents in its adjacent 'blockgroups'") in the investigations for drug charges from the police incidents dataset published in the City of Boston's Open Data portal.   
	</p>
</div>
