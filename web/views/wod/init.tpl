<div style="height: 100%; position: fixed; top: 0vh; left: 0; width: 100%; z-index: 10;">
	...
	<div data-chart="map" data-map_layers="counties,neighborhoods,boston_grid" id="mini_map" data-zoom_to="counties_25025" data-zoom_level="130" data-map_center_lat="42.319834" data-map_center_lon="-71.087294" style="position: absolute; top: 80%; left: 40%; width: 20%; height:20%;"></div>
	<h1 style="position: absolute; top: 80%; left: 20%">Drug Investigations</h1>
	<h1 style="position: absolute; top: 80%; left: 75%">Drug Arrests</h1>
</div>
<div style="position: relative; z-index: 100; border: 1px solid green; height: 10px;">
	<section data-slide="main" id="header">
		<div class="scene_separator">
		</div>
	</section>
	<section id="maps" style="height: 1px;">
		<div id="movie">
			<div class="scene">
				<h1>2011 - 2015</h1>
